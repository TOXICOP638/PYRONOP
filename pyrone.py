...
ONE_WORDS = ["MADARCHODD", "TUJHE", "PELTA", "HU", "BAAP", "SE", "BHIR", "GYA NA", "AB TERI", "MAA", "CHODTA HU",
           ...
           "THA","CHUDWANE","LAURE","AUR SUN","TEAM CRIMINAL FIGHTERS OP","BOLTE","BETA HAI TU","MERA","MAI TCF","TERA","BAAP HU","RANDI KE",
           "PILLE","GAANDU","TERII","BEHEN","KAAA","BOOBS","MEIN","INJECTION","GHUSERU","LAURE","TERA","APNA","DNA","KRWA",
           "TCF","TERA","BAAP","NIKLEGA","TERA","PURE","KHANDAN", "KO", "CHODUNGAA","BAAP","SEE","BAKCHODI","KAREGAA","SUARR",
           ...
           "KUTTE","SE BHI","CHHOTI","SMJHA NA","MADHARCHOD","BAAP SE","BAKCHODI","NAHI","TCF","TERA BAAP","SPEED","PAKAR",
